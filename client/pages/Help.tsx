...
import { ChevronLeft, ChevronRight, Mail, Phone, MessageCircle, FileText } from "lucide-react";
...
export default function Help() {
  ...
  const faqCategories = [
    {
      icon: <Package className="w-6 h-6 stroke-gray-medium" strokeWidth={1.67} />,
      title: "Orders & Shipping",
      description: "Track orders, shipping info",
    },
    {
      icon: <FileText className="w-6 h-6 stroke-gray-medium" strokeWidth={1.67} />,
      title: "Returns & Refunds",
      description: "Return policy, refund status",
    },
    {
      icon: <CreditCard className="w-6 h-6 stroke-gray-medium" strokeWidth={1.67} />,
  ...
  const contactOptions = [
    {
      icon: <MessageCircle className="w-6 h-6 stroke-brand-pink" strokeWidth={1.67} />,
      title: "Live Chat",
      ...
      <div className="px-6 pt-6 pb-8 flex flex-col gap-6">
        <div>
          ...
          <div className="relative">
            ...
            />
            <Search className="absolute right-4 top-1/2 -translate-y-1/2 w-5 h-5 stroke-gray-light" strokeWidth={2} />
          </div>
        </div>
...
function CreditCard(props: any) {
  return (
    <svg {...props} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M21 4H3C1.89543 4 1 4.89543 1 6V18C1 19.1046 1.89543 20 3 20H21C22.1046 20 23 19.1046 23 18V6C23 4.89543 22.1046 4 21 4Z" stroke="currentColor" strokeWidth="inherit" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M1 10H23" stroke="currentColor" strokeWidth="inherit" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
...
function Search(props: any) {
  return (
    <svg {...props} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M11 19C15.4183 19 19 15.4183 19 11C19 6.58172 15.4183 3 11 3C6.58172 3 3 6.58172 3 11C3 15.4183 6.58172 19 11 19Z" stroke="currentColor" strokeWidth="inherit" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M21 21L16.65 16.65" stroke="currentColor" strokeWidth="inherit" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
